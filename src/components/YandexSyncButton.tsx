  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md">
      <h2 className="text-2xl font-semibold mb-4 flex items-center">
        ...
        Yandex Fleet Синхронизация
      </h2>
      <p className="text-sm text-gray-600 mb-4">
        Нажмите, чтобы получить актуальный список водителей из вашего парка Яндекс.
      </p>
      ...
      >
        {isPending ? 'Синхронизация...' : 'Начать Синхронизацию Водителей'}
      </button>
